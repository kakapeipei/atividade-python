...
def cadastrar_novo_restaurante():
    """
    Funnção para cadastrar um novo restaurante
    ...
    Outputs:
    - Adiciona um novo restauante á lista de restaurantes
    """
...
def listar_restaurantes():
    ...
    print(f'{'nome_restaurante'.Ijust(21)} | {'categoria'.Ijust(20)} | Status')
